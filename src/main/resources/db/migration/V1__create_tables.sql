CREATE SEQUENCE SEQ_ESG_USUARIO START WITH 1 INCREMENT BY 1 NOCACHE;
...
CREATE TABLE ESG_USUARIO (
    id_usuario INTEGER DEFAULT SEQ_ESG_USUARIO.NEXTVAL PRIMARY KEY,
